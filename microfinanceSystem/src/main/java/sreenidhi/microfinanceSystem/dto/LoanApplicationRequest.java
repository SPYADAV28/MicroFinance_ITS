...
public class LoanApplicationRequest {
	...
	public String toString() {
		return "LoanApplicationRequest [name=" + name + ", gender=" + gender + ", maritalStatus=" + maritalStatus
				+ ", phone=" + phone + ", email=" + email + ", address=" + address + ", district=" + district
				+ ", state=" + state + ", pincode=" + pincode + ", dob=" + dob + ", aadharNumber=" + aadharNumber
				+ ", panNumber=" + panNumber + ", loanAmount=" + loanAmount + ", loanPurpose=" + loanPurpose
				+ ", hasExistingLoan=" + hasExistingLoan + ", existingLoanAmount=" + existingLoanAmount
				+ ", existingLoanProvider=" + existingLoanProvider + ", existingLoanEndDate=" + existingLoanEndDate
				+ ", businessName=" + businessName + ", businessType=" + businessType + ", businessAddress="
				+ businessAddress + ", termsAccepted=" + termsAccepted + ", submissionDate=" + submissionDate
